  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="flex items-center mb-6">
        <Folder className="h-6 w-6 text-indigo-600 mr-3" />
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">File Manager</h1>
      </div>
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mx-4 sm:mx-6 lg:mx-8">
        {/* Header with tabs */}
            ...
            {!sharedWithUsers && (
              <div className="flex space-x-1 bg-gray-100 p-1 rounded-lg">
                <button
                  ...
                  className={`py-2 px-4 rounded-md text-sm font-medium transition-colors ${activeTab === "files"
                ...
                <button
                  ...
                  className={`py-2 px-4 rounded-md text-sm font-medium transition-colors ${activeTab === "events"
                    ? "bg-white text-indigo-600 shadow-sm"
                    : "text-gray-600 hover:text-gray-900"
                    }`}
                >
        ...
        {activeTab === "files" && (
          <div className="p-4 sm:p-6">
            ...
            {/* Actions toolbar */}
            <div className="flex flex-wrap items-center justify-between gap-3 mb-6 bg-gray-50 p-3 rounded-lg">
              {/* Left side actions */}
              ...
              >
                {getSortedItems().map((item) => (
                  <div
                    ...
                    className={`
                    ${viewMode === "grid"
                        ? "border border-gray-200 rounded-lg p-4 hover:border-indigo-300 hover:shadow-md transition-all"
                        : "py-4 px-3 hover:bg-gray-50 transition-colors"
                      }
